...
public class ShortenerBitLy implements Shortener {
	...
	public String getShortenedUrl(String toshort) throws ShortifyException {
		...
		try {
			...
			shorted = new URL("http://api.bit.ly/v3/shorten?login=" + u + "&apiKey=" + a + "&longUrl=" + encoded + "&format=txt" );
	    ...
	    {    
	    	throw new ShortifyException("Unable to shorten via bit.ly: "+ex.getMessage());
	    }
		return inputLine;
	}
